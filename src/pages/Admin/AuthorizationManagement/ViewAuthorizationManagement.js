...
const ViewAuthorizationManagement = () => {
const { id } = useParams();
...
const token = localStorage.getItem("BackToBasic-token"); 
 ...
 const handleOptionChange = (event) => {
    setSchoolBased(event.target.value==="true");
  };
 ...
 const handleVerifiedInMHMSOptionChange = (event) => {
  ...
  apis.get(`/Authorization/GetAuthorization?id=${id}`,config)
            .then((res) => {
            console.log('API Response:', res.data.response);  
            setProgramManger(res.data.response.program_manager)   

            if (res.data.response.authorization_start_date) {
    const start = dayjs(res.data.response.authorization_start_date);
    setStartDate(start);
  }

  if (res.data.response.authorization_end_date) {
    const end = dayjs(res.data.response.authorization_end_date);
    setEndDate(end);
  }
   
        setAuthorizationNumber(res.data.response.authorization_number)
        setTotalUnit(res.data.response.total_units_authorized)
        setDiagnosisCode(res.data.response.diagnosis_code)
        setSchoolBased(res.data.response.school_based)
        setEPModifier(res.data.response.ep_modifier_on_kepro_authorization)
        setVerifiedInMHMS(res.data.response.verified_in_mhms)
        setSecondVerified(res.data.response.second_verified)
         setAddress1(res.data.response.address1)
         setAddress2(res.data.response.address2)
         setCity(res.data.response.address_city_on_kepro_authorization) 
         setZip(res.data.response.address_zipcode_on_kepro_authorization)
         setApprovedHoursWeek(res.data.response.total_approved_hours) 
         setTotalApprovedHours(res.data.response.total_approved_hours)
         setTotalUnitWorked(res.data.response.total_units_worked)
         setTotalHouresWorked(res.data.response.total_hours_worked)
         setTotalHouresWeekWorked(res.data.response.total_hours_per_week_worked)
            })
    }, [id])
                                  ...
                                  <div className="form-box-inner col-lg-4 col-md-6 mb-4">
                                    <div className="input-box">
                                      ...
                                      >
                                        ...
                                        <option value="Client_1">
                                          Client 1
                                        </option>
                                        <option value="Client_2">
                                          Client 2
                                        </option>
                                      </select>
                                    </div>
                                  ...
                                  <div className="form-box-inner col-lg-12 col-md-12 mb-0">
                                    <div className="input-box row align-items-center">
                                      ...
                                      <FormControl className="col">
                                       ...
                                       control={<Radio />}
                                       label="Yes"
                                       checked={schoolBased === true}
                                        />
                                          <FormControlLabel
                                            value="false"
                                            control={<Radio />}
                                            label="No"
                                           checked={schoolBased === false}
                                          />
                                        </RadioGroup>
                                      </FormControl>
                                    </div>
                                    ...
                                    <div className="input-box row align-items-center">
                                      ...
                                      <FormControl className="col">
                                        <RadioGroup
                                          ...
                                          name="row-radio-buttons-group"
                                         value={epModifier}
                                          onChange={handleEPModifierOptionChange}
                                        >
                                          <FormControlLabel
                                            value="true"
                                            control={<Radio />}
                                            label="Yes"
                                               checked={epModifier === true ? true : false}
                                          />
                                          <FormControlLabel
                                            value="false"
                                            control={<Radio />}
                                            label="No"
                                              checked={epModifier === false ? true : false}
                                          />
                                        </RadioGroup>
                                      </FormControl>
                                    </div>
                                    ...
                                    <div className="input-box row align-items-center">
                                      ...
                                      <FormControl className="col">
                                        <RadioGroup
                                          ...
                                          onChange={handleVerifiedInMHMSOptionChange}
                                        >
                                          <FormControlLabel
                                            value="true"
                                            control={<Radio />}
                                            label="Yes"
                                              checked={verifiedInMHMS === true ? true : false}
                                          />
                                          <FormControlLabel
                                            value="false"
                                            control={<Radio />}
                                            label="No"
                                             checked={verifiedInMHMS === false ? true : false}
                                          />
                                        </RadioGroup>
                                      </FormControl>
                                    </div>
                                    ...
                                    <div className="input-box row align-items-center">
                                      ...
                                      <FormControl className="col">
                                        <RadioGroup
                                          ...
                                          onChange={handleSecondVerifiedOptionChange}
                                        >
                                          <FormControlLabel
                                            value="true"
                                            control={<Radio />}
                                            label="Yes"
                                                checked={secondVerified === true ? true : false}
                                          />
                                          <FormControlLabel
                                            value="false"
                                            control={<Radio />}
                                            label="No"
                                            checked={secondVerified === false ? true : false}
                                          />
                                        </RadioGroup>
                                      </FormControl>
                                    </div>
                                  ...
                                  <div className="form-box-inner col-lg-6 col-md-6 mb-4">
                                    <div className="input-box">
                                      ...
                                      <input
                                        ...
                                        onChange={(e) => {
                                        setTotalHouresWeekWorked(e.target.value);
                                        }}
                                      />
                                    </div>
                                  </div>
...
export default ViewAuthorizationManagement;
