...
const handleDownload = () => {
  ...
  useEffect(() => {
    ...
    apis.get(`/Client/GetAllClients?pageNumber=1&pageSize=30&sortColumn=client_last_name&sortDirection=asc&searchName=${searchQuery}`,config)
            .then((res) => {
              console.log(res);  
  ...
  const handleDelete = async (itemId) => {
    ...
    apis.delete(`/Client/DeleteClient?id=${itemId}`,config)
            .then((res) => {
                      ...
                      <div className="col">
                        <div className="card-top-filter-box p-3">
                          ...
                          <div className="tableRightLink d-flex ">
                            <Link to='/add-edit-information'><i className='addPage'><img className="linkImg" src={plusIcon} /></i> Add New Client</Link>
                            <Link to='' className='imgWithLink ms-2'><img className="linkImg" src={downloadFile} onClick={handleDownload} /> Download Report</Link>
                          </div>
                          {/* Right Filter */}
                        </div>
                      </div>
                      ...
                      <div className="col">
                        <div className="table-responsive">
                          <table className="table m-0 butifyTable">
                            ...
                            <tbody>
                              {clients.length >0 ? clients.map((r) => 
                               
                                  <tr>
                                    <td>{r.client_first_name + " " + r.client_last_name}</td>
                                    ...
                                    <td className='text-center'>
                                      <div className="btn-group dropstart table-action">
                                        ...
                                        <ul className="dropdown-menu">
                                          ...
                                          <li> <p onClick={() => handleEditClient(r.id)} className="dropdown-item" > <EditIcon /> Edit </p> </li>
