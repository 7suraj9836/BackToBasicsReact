...
const IndividualTreatmentPlan = ({ employeeAction }) => {
  ...
  useEffect(() => {
    ...
    apis.get(`/IndividualTreatmentPlan/GetAllIndividualTreatmentPlans?pageNumber=1&pageSize=20&searchName=${searchQuery}`,config)
            .then((res) => {
              console.log(res);  
  ...
  const handleView = (id) => {
    navigate(`/view-Itp-Client/${id}`);
  }

  const handleEditItp = (id) => {
    navigate(`/edit-Itp-Client/${id}`);   
  }
  ...
  const handleDelete = async (itemId) => {
    ...
    apis
      .delete(
        `/IndividualTreatmentPlan/DeleteIndividualTreatmentPlan?id=${itemId}`,
        config
      )
                      ...
                      <div className="col">
                        <div className="card-top-filter-box p-3">
                          ...
                          <div className="tableRightLink d-flex ">
                            <Link to="/add-edit-individual-treatment-plan">
                              <i className="addPage">
                                <img
                                  className="linkImg"
                                  src={plusIcon}
                              ...
                              Add New Individual Treatment plan
                            </Link>
                          ...
                          <table className="table m-0 butifyTable">
                            <thead>
                              <tr>
                                ...
                                <th>Issues</th>
                                <th>ITp Period</th>
                                <th>90 days Review date</th>
                                <th>ItP Revision require</th>
...
export default IndividualTreatmentPlan
