...
function EditIndividualTreatmentPlan() {
  let data = {
    goal: "",
    objectives: [
      {
  ...
  const [supportForMemberSaftey, SetSupportForMemberSaftey] =useState(supportMemeberSaftey);
  ...
  useEffect(() => {
    ...
    apis.get(`/IndividualTreatmentPlan/GetIndividualTreatmentPlan?id=${id}`, config)
      .then((res) => {
        ...
        setIndividualTreatmentPeriod(res.data.response.individual_treatment_plan_period);
        ...
        setClientName(res.data.response.implementing_discharge_plan_client_name);
        setClientFamilyMember(res.data.response.implementing_discharge_plan_client_family_name);
        SetSupportForMemberSaftey(res.data.response.support_needed_for_the_member_safety);
        setPotentialTrigger(res.data.response.potential_triggers_which_may_result_in_a_crisis);
        setStrategiesAndTechniques( res.data.response.strategies_and_techniques_to_stabilize_the_situation );
        setIndividualsResponsible(res.data.response.individuals_responsible_for_plan_implementation);
  ...
  let handleSubmit = async () => {
    if (true) {
      ...
      formData.append("implementing_discharge_plan_client_family_name", clientFamilyMember);
      formData.append("support_needed_for_the_member_safety", supportForMemberSaftey);
      formData.append("potential_triggers_which_may_result_in_a_crisis", potentialTrigger);
      formData.append("Strategies_and_techniques_to_stabilize_the_situation", strategiesAndTechniques);
      formData.append("individuals_responsible_for_plan_implementation", individualsResponsible);
...
export default EditIndividualTreatmentPlan;
