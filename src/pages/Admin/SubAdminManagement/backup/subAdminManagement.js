...
const SubAdminManagement = () => {
  ...
  const handleDownload = () => {
    ...
    apis.get("/SubAdmin/DownloadSubAdminDataReport", config)
      .then((response) => {
                                  ...
                                  <td className='text-center'>
                                    <div className="btn-group dropstart table-action">
                                      ...
                                      <ul className="dropdown-menu">
                                        <li> <p onClick={() => handleView(r.id)} className="dropdown-item" > <VisibilityIcon /> </p> </li>
                                        <li> <p onClick={() => handleEditSubAdmin(r.id)} className="dropdown-item" > <EditIcon /> </p> </li>
                                        <li> <p onClick={() => handleDelete(r.id)} className="dropdown-item" > <DeleteIcon /> </p> </li>
