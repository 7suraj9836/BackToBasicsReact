...
const EditClientSchedule = () => {
  ...
  useEffect(() => {
    ...
    apis
      .get(
        `/ClientAvailability/GetAllClientAvailabilities?pageNumber=1&pageSize=10&sortColumn=client_last_name&sortDirection=asc&searchName=${searchQuery}`,
        config
      )
      .then((res) => {
        setClients(res.data.records);
        console.log(res.data.records, "r");
      })
      .catch((error) => {
        Swal.fire({
          icon: "error",
  ...
  const handleDelete = async (itemId) => {
    ...
    apis
      .delete(
        `/ClientAvailability/DeleteClientAvailability?id=${itemId}`,
        config
      )
      .then((res) => {
        ...
        Swal.fire({
          icon: "success",
          timer: 1500,
          text: `Client schedule delete successfully`,
          showConfirmButton: false,
        });
      })
      .catch((error) => {
                      ...
                      <div className="col">
                        <div className="card-top-filter-box p-3">
                          ...
                          <div className="tableRightLink d-flex ">
                            <Link to="/client-schedule-management">
                              <i className="addPage">
...
export default EditClientSchedule;
